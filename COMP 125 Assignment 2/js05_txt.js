...
favesTitle.textContent = "You can add up to five photos below. Click on a photo to add a button to remove it.";
myTitle.appendChild(favesTitle);

let favesInstructions = document.createElement("h3");
favesInstructions.className = "favesInstructions";
favesInstructions.textContent = "Favourite Photos:";
favesTitle.appendChild(favesInstructions);
